...
Como cierre predictivo se incorpora un modelo HAR-logRV compacto basado en memoria multiescala de volatilidad realizada \cite{corsi2009}. Este modelo combina información de la última hora, las últimas cuatro horas y el último día, y lidera la comparación histórica sobre la muestra.

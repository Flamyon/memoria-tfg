...
\section{Cierre técnico del procedimiento y artefactos generados}\label{sec}
...
Los principales artefactos del procedimiento son el dataset \texttt{btc\_\allowbreak 5m\_\allowbreak features.csv}, los embeddings de entrenamiento y prueba de la Fase 8, los coeficientes del AR(49), las métricas de predicción local, los resultados de sensibilidad, las salidas de la comprobación sintética y el modelo \texttt{har\_\allowbreak logrv\_\allowbreak model.json}. Este último se guarda en \texttt{data/\allowbreak model\_\allowbreak artifacts/} para ser consumido por el MVP web sin importar código del repositorio técnico.
